...
<head>
    ...
    <link rel="stylesheet" href="{{mosi_iframeTabAsset('/vendor/iframe-tab/css/swiper.min.css')}}">
    <link rel="stylesheet" href="{{mosi_iframeTabAsset('/vendor/iframe-tab/css/style.css')}}">
</head>
